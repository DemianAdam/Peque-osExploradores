...
interface PayslipFeeModalProps {
  ...
  onClose: () => void;
  feeAmount: number;
  onFeeChange: (amount: number) => void;
  onConfirm: () => void;
}

export function PayslipFeeModal({ isOpen, onClose, feeAmount, onFeeChange, onConfirm }: PayslipFeeModalProps) {
